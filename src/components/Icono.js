...
const T = {
  ...
  candado: (x) => (
    <>
      <Rect x="4.8" y="10.4" width="14.4" height="10.4" rx="2.2" {...x} />
      <Path d="M8 10.4V7.6a4 4 0 0 1 8 0v2.8" {...x} />
      <Line x1="12" y1="14.6" x2="12" y2="16.6" {...x} />
    </>
  ),
  correo: (x) => (
    <>
      <Rect x="3.2" y="5.2" width="17.6" height="13.6" rx="2.2" {...x} />
      <Polyline points="3.8 6.6 12 12.8 20.2 6.6" {...x} />
    </>
  ),
  usuarios: (x) => (
    <>
      <Circle cx="9" cy="8.4" r="3.4" {...x} />
      <Path d="M2.8 20.2a6.2 6.2 0 0 1 12.4 0" {...x} />
      <Path d="M15.6 5.2a3.4 3.4 0 0 1 0 6.4" {...x} />
      <Path d="M17.6 14.4a6.2 6.2 0 0 1 3.6 5.8" {...x} />
    </>
  ),
  camara: (x) => (
    <>
  ...
  escudo: (x) => <Path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" {...x} />,
};
